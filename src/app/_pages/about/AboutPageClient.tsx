...
const copy = {
  ...
  "zh-Hans": {
    eyebrow: "关于我们",
    heading: "关于 Panorama Scholarly Books",
    subheading: "出版者信息、使命与学术标准。",
    missionHeading: "使命",
    missionP1:
      "Panorama Scholarly Books 致力于出版有助于学术交流、跨学科研究与全球知识共享的学术著作。",
    missionP2:
      "作为 Panorama Scholarly Group 的一部分，本平台通过负责任的出版实践与专业的制作服务，支持学术作者、编者、研究人员与机构。我们致力于维持严谨的学术标准、支持思想多元性，并让全球的研究人员、教育工作者与从业者都能获取严肃的学术成果。",
    scopeHeading: "出版范畴",
    scopeIntro:
      "我们出版学术专著、编著文集、研究报告、学术教材、会议论文集，以及以下领域的跨学科著作：",
    fields: [
      "人文学科",
      "社会科学",
      "教育与教育政策",
    ...
    publisherInfoHeading: "出版者信息",
    publisherInfo: [
      ["法定出版者", "Panorama Scholarly Group Limited"],
      ["出版品牌", "Panorama Scholarly Books"],
      ["类型", "独立学术图书出版社"],
      ["注册地址", "香港旺角弥敦道625号雅兰中心办公楼二期15楼1508室"],
      ["网站", "books.panorama-sg.com"],
      ["出版咨询", "books@panorama-sg.com"],
    ],
    standardsHeading: "学术标准",
    standardsP1:
      "Panorama Scholarly Books 致力于维护学术著作诚信的负责任出版实践。所有投稿均需经过编辑审查，评估其学术价值、原创性、方法严谨性与论述清晰度。",
    standardsP2:
      "我们的出版政策涵盖研究与出版伦理的关键面向，包括著作权归属、抄袭、利益冲突、数据诚信，以及人工智能在研究与写作中的使用。作者须阅读并遵守这些政策，方可获得出版。",
    readPolicies: "阅读我们的出版政策",
    relationshipHeading: "与 Panorama Scholarly Group Limited 的关系",
    relationshipP1:
      "Panorama Scholarly Books 是 Panorama Scholarly Group Limited 旗下的学术图书出版品牌。Panorama Scholarly Group Limited 为负责出版协议、出版管理、书目记录、ISBN 使用，以及 Panorama Scholarly Books 品牌出版事务的法定实体。",
    relationshipP2:
      "在 Panorama Scholarly Group Limited 更广泛的学术出版业务（亦涵盖学术期刊、会议论文集与研究传播服务）之下，Panorama Scholarly Books 维持自身独立的编辑定位、作者关系、书目、出版政策与制作标准。",
    contactHeading: "联系方式",
      ...
      <Container narrow>
        <div className="py-12 lg:py-16">
          ...
          <section className="mb-14">
            ...
            <Link
              href={localeHref("/policies", locale)}
