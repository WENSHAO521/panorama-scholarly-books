...
const copy = {
  ...
  "zh-Hans": {
    eyebrow: "目录",
    heading: "书目",
    subheading: "Panorama Scholarly Books 所有已出版及即将出版的书目。",
    searchPlaceholder: "按书名、作者或学科搜索",
    searchAria: "搜索书目",
    noMatch: "没有符合搜索条件的书目。",
    noneYet: "此分类目前暂无书目。",
    tryDifferent: "请尝试其他书名、作者或学科领域。",
    checkBack: "我们会定期新增书目，请稍后再回来查看。",
    forthcomingNote:
      "本目录呈现目前所有已公布及已出版的书目。其他书目仍在准备中，一经公布即会显示于此。如有书稿查询，请联系",
  },
} as const;

export default function BooksPageClient({ locale }: { locale: Locale }) {
  const t = copy[locale];
