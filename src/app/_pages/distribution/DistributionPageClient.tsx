...
const copy = {
  ...
  "zh-Hans": {
    eyebrow: "发行",
    heading: "销售与发行",
    subheading: "有关 Panorama Scholarly Books 书目销售与发行现状的信息。",
    currentStatusHeading: "目前发行状况",
    currentStatusIntro: "Panorama Scholarly Group Limited 正逐步发展其图书销售与发行渠道。每本符合资格的 Panorama Scholarly Books 书目均享有以下服务：",
    currentStatusItems: [
      "Panorama Scholarly Books 网站上的官方图书页面",
      "出版者及书目元数据（书名、作者、学科分类）",
      "对应核准版次及产品格式的 ISBN 信息",
      "数字化存档与出版记录",
    ],
    currentStatusNote: "对符合资格的书目，发行至商业零售渠道、图书馆网络及开放获取平台属可选服务。请联系图书部门咨询您书目的发行选项。",
    directOrderHeading: "直接订购与采购咨询",
    directOrderBody: "如需索取个别样书、机构采购咨询，或询问获取特定书目的方式，请直接联系图书部门。",
    booksDepartment: "图书部门",
    orderInquiry: "订购咨询",
    podHeading: "按需印刷",
    podBody1: "已与按需印刷（POD）服务供应商建立合作安排的特定书目，可提供按需印刷服务。若某书目提供按需印刷，将在该书目的详情页面标明。",
    podBody2: "有意为其书目启用按需印刷的作者及出版方，请联系图书部门咨询资格及设置要求。",
    ebookHeading: "电子书发行",
    ebookBody1: "通过 Google Play Books 等平台的电子书发行渠道正为符合资格的书目筹备中。若某书目已提供电子书获取渠道，将列于该书目的详情页面。",
    ebookBody2: "已制作数字版本（PDF、EPUB）的作者，可咨询将其书目纳入电子书发行的可选服务。",
    institutionalHeading: "机构采购咨询",
    institutionalBody: "图书馆、大学、研究机构及其他有意采购 Panorama Scholarly Books 书目的机构，请联系图书部门。我们可配合机构采购需求并按要求提供发票。",
    institutionalSubmit: "提交机构采购咨询",
    futureHeading: "未来发行渠道",
    futureIntro: "Panorama Scholarly Group 正致力于扩展发行安排，可能涵盖以下渠道：",
    futureItems: [
      "Amazon（纸质版及 Kindle）",
      "Google Play Books",
      "IngramSpark",
    ...
    noticeHeading: "重要须知",
    noticeP1: "商业零售发行、按需印刷、电子书平台发行、图书馆供应及第三方元数据服务均属可选服务，除非书面另有明确说明，否则不包含在标准出版方案内。发行服务的可提供性取决于书目本身、出版格式、地域版权、技术文件、平台要求及第三方核准。",
    noticeP2: "Panorama Scholarly Books 并不保证书店上架、平台接受、图书馆采购、销售量、排名、索引收录、书评、引用次数或商业表现。",
  },
} as const;

export default function DistributionPageClient({ locale }: { locale: Locale }) {
  const t = copy[locale];
