...
const acceptedTypes = [
  {
    type: { en: "Scholarly Monographs", "zh-Hant": "學術專著", "zh-Hans": "学术专著" },
    desc: {
      ...
      "zh-Hans": "由一位或多位作者撰写的原创研究著作，提出具有连贯性的论述或调查研究。",
    },
  },
  {
    type: { en: "Edited Volumes", "zh-Hant": "編著文集", "zh-Hans": "编著文集" },
    desc: {
      ...
      "zh-Hans": "由多位撰稿人撰写原创章节，并由一位或多位编者统筹并撰写导言的文集。",
    },
  },
  {
    type: { en: "Academic Textbooks", "zh-Hant": "學術教材", "zh-Hans": "学术教材" },
    desc: {
      en: "Pedagogically structured works designed for use in higher education curricula.",
      "zh-Hant": "依教學需求編排、供高等教育課程使用的著作。",
      "zh-Hans": "依教学需求编排、供高等教育课程使用的著作。",
    },
  },
  {
    type: { en: "Research Reports", "zh-Hant": "研究報告", "zh-Hans": "研究报告" },
    desc: {
      ...
      "zh-Hans": "呈现研究项目、系统性综述或政策调查成果的结构化报告。",
    },
  },
  {
    type: { en: "Conference Proceedings", "zh-Hant": "會議論文集", "zh-Hans": "会议论文集" },
    desc: {
      en: "Collections of peer-reviewed papers presented at academic conferences.",
      "zh-Hant": "收錄於學術會議發表並經同行評審之論文集。",
      "zh-Hans": "收录于学术会议发表并经同行评审的论文集。",
    },
  },
  {
    type: { en: "Doctoral Dissertation-Based Books", "zh-Hant": "博士論文改編專書", "zh-Hans": "博士论文改编专书" },
    desc: {
      en: "Substantially revised and expanded works based on doctoral theses.",
      "zh-Hant": "以博士論文為基礎，經大幅修訂與擴充的著作。",
      "zh-Hans": "以博士论文为基础，经大幅修订与扩充的著作。",
    },
  },
  {
    type: { en: "Interdisciplinary Research Books", "zh-Hant": "跨學科研究專書", "zh-Hans": "跨学科研究专书" },
    desc: {
...
const whoCanSubmit = [
  {
    ...
    "zh-Hans": "任何职业阶段的学术作者，包括早期职业研究人员",
  },
  {
    en: "Editors assembling interdisciplinary or field-specific edited volumes",
    "zh-Hant": "籌組跨學科或特定領域編著文集的編者",
    "zh-Hans": "筹组跨学科或特定领域编著文集的编者",
  },
  {
    en: "Researchers working independently or affiliated with academic institutions",
    "zh-Hant": "獨立研究者或隸屬學術機構的研究人員",
    "zh-Hans": "独立研究者或隶属学术机构的研究人员",
  },
  {
    en: "Research groups and policy institutes seeking to disseminate findings",
    "zh-Hant": "希望發表研究成果的研究團隊與政策機構",
    "zh-Hans": "希望发表研究成果的研究团队与政策机构",
  },
  {
    en: "Conference organisers wishing to publish proceedings",
    "zh-Hant": "希望出版會議論文集的會議主辦單位",
    "zh-Hans": "希望出版会议论文集的会议主办单位",
  },
  {
    en: "Doctoral graduates seeking to revise and publish their dissertations",
    "zh-Hant": "希望修訂並出版其論文的博士畢業生",
    "zh-Hans": "希望修订并出版其论文的博士毕业生",
  },
];

const requiredDocs = [
  { en: "Book proposal (see below for content requirements)", "zh-Hant": "圖書提案（內容要求詳見下方）", "zh-Hans": "图书提案（内容要求详见下方）" },
  { en: "Author or editor CV", "zh-Hant": "作者或編者履歷", "zh-Hans": "作者或编者履历" },
  { en: "Sample chapters or full manuscript", "zh-Hant": "樣章或完整書稿", "zh-Hans": "样章或完整书稿" },
  { en: "Table of contents", "zh-Hant": "目錄", "zh-Hans": "目录" },
  { en: "Abstract and book description (200-400 words)", "zh-Hant": "摘要及內容簡介（200-400字）", "zh-Hans": "摘要及内容简介（200-400字）" },
  { en: "Statement of target readership", "zh-Hant": "目標讀者說明", "zh-Hans": "目标读者说明" },
  { en: "Statement of publication purpose and scholarly contribution", "zh-Hant": "出版目的與學術貢獻說明", "zh-Hans": "出版目的与学术贡献说明" },
  { en: "Declaration of originality", "zh-Hant": "原創性聲明", "zh-Hans": "原创性声明" },
  { en: "Permission documents for third-party materials, where applicable", "zh-Hant": "第三方材料授權文件（如適用）", "zh-Hans": "第三方材料授权文件（如适用）" },
];

const proposalContent = [
  { en: "Working title and subtitle", "zh-Hant": "暫定書名及副題", "zh-Hans": "暂定书名及副标题" },
  { en: "Author / editor details and institutional affiliation", "zh-Hant": "作者／編者資料及所屬機構", "zh-Hans": "作者/编者资料及所属机构" },
  { en: "Book type (monograph, edited volume, etc.)", "zh-Hant": "圖書類型（專著、編著文集等）", "zh-Hans": "图书类型（专著、编著文集等）" },
  { en: "Subject area and disciplinary focus", "zh-Hant": "學科領域及研究重點", "zh-Hans": "学科领域及研究重点" },
  { en: "Description of the book and its central argument", "zh-Hant": "圖書內容簡介及核心論點", "zh-Hans": "图书内容简介及核心论点" },
  { en: "Table of contents with chapter summaries", "zh-Hant": "含各章摘要之目錄", "zh-Hans": "含各章摘要的目录" },
  { en: "Target readership and course adoption potential, if relevant", "zh-Hant": "目標讀者及課程採用潛力（如適用）", "zh-Hans": "目标读者及课程采用潜力（如适用）" },
  { en: "Estimated word count and projected completion date", "zh-Hant": "預估字數及完成日期", "zh-Hans": "预估字数及完成日期" },
  { en: "List of competing or complementary titles", "zh-Hant": "同類或互補書目清單", "zh-Hans": "同类或互补书目清单" },
  { en: "Status of the manuscript (draft, in progress, complete)", "zh-Hant": "書稿狀態（草稿、撰寫中、已完成）", "zh-Hans": "书稿状态（草稿、撰写中、已完成）" },
];

const processSteps = [
  {
    step: { en: "Proposal Submission", "zh-Hant": "提交提案", "zh-Hans": "提交提案" },
    desc: {
      ...
      "zh-Hans": "提交图书提案、作者或编者履历、目录、样章或完整书稿、内容简介、目标读者说明、原创性声明及相关授权信息。",
    },
  },
  {
    step: { en: "Initial Editorial Screening", "zh-Hant": "初步編輯審查", "zh-Hans": "初步编辑审查" },
    desc: {
      ...
      "zh-Hans": "编辑团队评估项目的学科范畴、学术贡献、原创性、伦理及法律适当性，以及基本制作可行性，一般需时两至四周。",
    },
  },
  {
    step: { en: "Editorial Evaluation", "zh-Hant": "編輯評估", "zh-Hans": "编辑评估" },
    desc: {
      ...
      "zh-Hans": "符合条件的提案将进入详细编辑评估，必要时可能安排外部学术审查。",
    },
  },
  {
    step: { en: "Publication Decision", "zh-Hant": "出版決定", "zh-Hans": "出版决定" },
    desc: {
      ...
      "zh-Hans": "作者或编者将收到以下其中一项决定：接受、有条件接受待修订、修订后重新提交，或不接受。费用报价并不构成编辑接受。",
    },
  },
  {
    step: { en: "Publishing Agreement and Payment", "zh-Hant": "出版協議與付款", "zh-Hans": "出版协议与付款" },
    desc: {
      ...
      "zh-Hans": "获接受的项目将签署书面出版协议，载明出版格式、服务内容、责任、费用、付款时程、版权与授权、制作范围、校订轮次、预估时程，以及印刷与发行安排。",
    },
  },
  {
    step: { en: "Rights and Metadata Verification", "zh-Hant": "版權與元數據核實", "zh-Hans": "版权与元数据核实" },
    desc: {
      ...
      "zh-Hans": "出版者核实最终书名及副标题、作者与编者姓名、撰稿人信息、所属机构、版权归属、第三方授权、版次及产品格式、出版语言、内容简介、学科分类及出版者信息。",
    },
  },
  {
    step: { en: "Production", "zh-Hant": "製作", "zh-Hans": "制作" },
    desc: {
      ...
      "zh-Hans": "项目依协议进行校对、编辑、排版、封面设计、文件准备及校订流程。",
    },
  },
  {
    step: { en: "ISBN Assignment and Final Approval", "zh-Hant": "ISBN 分配與最終核准", "zh-Hans": "ISBN 分配与最终核准" },
    desc: {
      ...
      "zh-Hans": "出版格式及书目元数据经核准后，出版者将分配对应 ISBN，并完成版权页及条码信息。ISBN 的分配并不代表未完成或不合规的文件已获最终出版核准。",
    },
  },
  {
    step: { en: "Publication", "zh-Hant": "出版", "zh-Hans": "出版" },
    desc: {
      ...
      "zh-Hans": "经最终核准并缴清所有未付费用后，该书将获得出版者最终核准、正式出版日期、最终书目元数据、官方图书网页、出版记录及数字化存档。",
    },
  },
  {
    step: { en: "Registration, Deposit, and Archiving", "zh-Hant": "登記、送存與典藏", "zh-Hans": "登记、送存与典藏" },
    desc: {
      ...
      "zh-Hans": "如适用，出版者将协调出版后登记、法定送存安排、出版记录及长期数字化存档。另行开立发票的印刷、装订、送存本、运送及第三方费用，仍由作者或委托机构负责。",
    },
  },
];
...
const manuscriptRequirements = [
  {
    label: { en: "Language", "zh-Hant": "語言", "zh-Hans": "语言" },
    text: {
      ...
      "zh-Hans": "书稿可以英文提交。双语或非英文投稿将个案考量。作者须自行确保语言质量。",
    },
  },
  {
    label: { en: "Length", "zh-Hant": "篇幅", "zh-Hans": "篇幅" },
    text: {
      ...
      "zh-Hans": "一般专著约60,000至120,000字；编著文集约80,000至150,000字；研究报告约20,000至60,000字。具体篇幅要求请与编辑团队讨论。",
    },
  },
  {
    label: { en: "Format", "zh-Hant": "格式", "zh-Hans": "格式" },
    text: {
      ...
      "zh-Hans": "书稿应以格式一致的 Microsoft Word 文件（.docx）提交，最终制作文件将在后续阶段另行要求。",
    },
  },
  {
    label: { en: "Style", "zh-Hant": "格式規範", "zh-Hans": "格式规范" },
    text: {
      ...
      "zh-Hans": "作者应全文一致采用公认的引用格式（APA 7、芝加哥格式或 MLA）。脚注、尾注及参考文献应完整准确。",
    },
  },
  {
    label: { en: "Permissions", "zh-Hant": "授權", "zh-Hans": "授权" },
    text: {
      ...
      "zh-Hans": "作者须自行取得并记录书稿中重制的任何第三方材料的授权，包括图表、照片及大段引文。",
    },
  },
];

const onThisPage = [
  { href: "#what-we-publish", label: { en: "What We Publish", "zh-Hant": "我們出版的內容", "zh-Hans": "我们出版的内容" } },
  { href: "#who-can-submit", label: { en: "Who Can Submit", "zh-Hant": "投稿資格", "zh-Hans": "投稿资格" } },
  { href: "#required-documents", label: { en: "Required Documents", "zh-Hant": "所需文件", "zh-Hans": "所需文件" } },
  { href: "#proposal-content", label: { en: "Proposal Content", "zh-Hant": "提案內容", "zh-Hans": "提案内容" } },
  { href: "#review-process", label: { en: "Review Process", "zh-Hant": "審查流程", "zh-Hans": "审查流程" } },
  { href: "#manuscript-requirements", label: { en: "Manuscript Requirements", "zh-Hant": "書稿要求", "zh-Hans": "书稿要求" } },
  { href: "#submit", label: { en: "Submit an Inquiry", "zh-Hant": "提交查詢", "zh-Hans": "提交咨询" } },
];
...
const copy = {
  ...
  "zh-Hans": {
    eyebrow: "作者专区",
    heading: "与 Panorama Scholarly Books 一同出版",
    subheading: "为有意与 Panorama Scholarly Books 合作出版的作者及编者提供的信息。",
    onThisPage: "本页内容",
    readyToSubmit: "准备好投稿了吗？",
    contactEditorialTeam: "联系编辑团队",
    whatWePublish: "我们出版的内容",
    whatWePublishIntro: "Panorama Scholarly Books 出版原创、经审查的学术著作，涵盖广泛的人文、社会科学、教育及跨学科领域。我们致力于维持严谨的学术标准、扎实的论述，以及通俗易懂的学术写作风格。",
    whoCanSubmit: "投稿资格",
    whoCanSubmitIntro: "我们欢迎以下人士投稿：",
    requiredDocuments: "所需文件",
    submissionsMustInclude: "投稿须包含以下文件：",
    bookProposalContent: "图书提案内容",
    proposalContentIntro: "图书提案应为1,000至3,000字的文件，并涵盖以下内容：",
    reviewProcess: "审查与出版流程",
    manuscriptRequirementsHeading: "书稿要求",
    submitInquiry: "提交咨询",
    submitIntro: "如需提交图书提案或讨论出版项目，请电邮图书部门，并将提案及相关辅助文件以附件形式提供。",
    booksEditorialTeam: "图书编辑团队",
    submitProposal: "提交提案",
    allowResponse: "请预留2-4周用于提案的初步回复。如需补充信息，编辑团队将与您联系。如对服务及费用有任何疑问，也可参阅",
    publishingServicesPage: "出版服务",
    pageSuffix: "页面。",
  },
} as const;

export default function ForAuthorsPageClient({ locale }: { locale: Locale }) {
  const t = copy[locale];
            ...
            <section id="submit" className="scroll-mt-24">
              ...
              <div className="mt-4 border border-[#e2e2e2] bg-[#f7f7f7] p-5">
                <p className="font-serif text-xs text-[#888888] leading-relaxed">
                  {t.allowResponse}{" "}
                  <Link href={localeHref("/publishing-services", locale)} className="underline underline-offset-2 hover:text-[#555555] transition-colors">
