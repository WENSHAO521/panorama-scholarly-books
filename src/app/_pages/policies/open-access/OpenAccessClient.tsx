...
const content: PolicyContent = {
  ...
  sections: [
    {
      heading: { en: "1. Open Access at Panorama Scholarly Books", "zh-Hant": "一、Panorama Scholarly Books 之開放獲取", "zh-Hans": "一、Panorama Scholarly Books 的开放获取" },
      blocks: [
        {
          type: "p",
          content: {
            ...
            "zh-Hans": "Panorama Scholarly Books 支持以开放获取方式扩大学术研究的可获取性与影响力。Panorama Scholarly Books 出版的特定书目，可依本政策及个别出版协议所载条件，以开放获取方式提供。",
          },
        },
        {
          type: "p",
          content: {
            ...
            "zh-Hans": "凡以开放获取方式出版的书目，将在官方图书页面上明确标示，并注明适用的许可条款。",
          },
        },
      ],
    },
    {
      heading: { en: "2. Default Open Access Licence", "zh-Hant": "二、預設開放獲取授權", "zh-Hans": "二、默认开放获取许可" },
      blocks: [
        {
          type: "p",
          content: {
            ...
            "zh-Hans": "除非另有协议，Panorama Scholarly Books 出版的开放获取书目，均依知识共享\"署名-非商业性使用-禁止演绎\"4.0国际许可协议（CC BY-NC-ND 4.0）提供。",
          },
        },
        {
          type: "p",
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              "zh-Hans": "未经授权，不得发布衍生著作（如翻译、改编、节录本）。",
            },
          ],
        },
        {
          ...
          content: {
            ...
            "zh-Hans": "有意采用其他知识共享许可协议（例如 CC BY 或 CC BY-NC）出版的作者，应在签署出版协议前与出版者讨论。",
          },
        },
      ],
    },
    {
      heading: { en: "3. Conditions for Open Access Publication", "zh-Hant": "三、開放獲取出版之條件", "zh-Hans": "三、开放获取出版的条件" },
      blocks: [
        {
          type: "p",
          content: {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              "zh-Hans": "著作中所含第三方材料，如有需要须取得开放获取重制的授权。",
            },
          ],
        },
      ],
    ...
    {
      heading: { en: "4. Open Access and Funder Requirements", "zh-Hant": "四、開放獲取與資助機構之要求", "zh-Hans": "四、开放获取与资助机构的要求" },
      blocks: [
        {
          type: "p",
          content: {
            ...
            "zh-Hans": "部分研究资助机构要求受资助研究的成果须以开放获取方式公开。有此义务的作者，建议在提案阶段即通知出版者，以便作出适当安排。",
          },
        },
        {
          type: "p",
          content: {
            ...
            "zh-Hans": "Panorama Scholarly Books 将在其出版安排范围内，尽合理努力配合资助机构的开放获取规定。",
          },
        },
      ],
    },
    {
      heading: { en: "5. Inquiries", "zh-Hant": "五、查詢", "zh-Hans": "五、查询" },
      blocks: [
        {
          type: "p",
          content: {
            ...
            "zh-Hans": <>如对开放获取出版有任何查询，请联系 {mailLink}，主旨请注明"Open Access Inquiry"。</>,
          },
        },
      ],
    },
...
export default function OpenAccessClient({ locale }: { locale: Locale }) {
